...
#include "../../../Sources/Headers/boss.h"
...
constexpr auto qt_meta_stringdata_CLASSBossENDCLASS = QtMocHelpers::stringData(
    "Boss",
    "BossDeads",
    "",
    "BossDead"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSBossENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Boss::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSBossENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSBossENDCLASS,
    qt_static_metacall,
    nullptr,
...
void Boss::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->BossDeads(); break;
        case 1: _t->BossDead(); break;
        default: ;
        }
        ...
        {
            using _t = void (Boss::*)();
            if (_t _q_method = &Boss::BossDeads; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
